...
<section class="container-block presentation">
    <?if(!empty($arParams["FILE_BACKGROUND"])):?>
        <img src="<?=$arParams["FILE_BACKGROUND"]?>" class="presentation__fon">
    <?endif;?>
    <div class="presentation-block wow fadeInUp">
        <div class="presentation-block__title">
            <?=$arParams["PARAMS_NAME"]?> <span><?=$arParams["PARAMS_SUB_TITLE"]?></span>
        </div>
